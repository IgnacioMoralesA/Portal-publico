...
| Pruebas automatizadas con cobertura 100% | pendiente | Suite pytest existe, pero no hay medicion/cierre 100%. | `tests/`, `docs/SCOPE_COMPLIANCE_MATRIX.md` | Resultado previo: 71 passed antes de este ciclo. | Agregar pytest-cov, definir scope y cubrir brechas. |
